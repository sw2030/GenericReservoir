function spe10_cpu(fn)
    ϕ = h5read(fn, "data/porosity")
    kx = h5read(fn, "data/kx")
    ky = h5read(fn, "data/ky")
    kz = h5read(fn, "data/kz")
    logradius = h5read(fn, "data/logrerw")
